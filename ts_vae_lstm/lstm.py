...
# %% auto 0
__all__ = ['num_workers', 'device', 'BASEDIR', 'MODELDIR', 'DATAPATH', 'get_embeddings', 'TSLSTMDataset', 'LSTMModel',
           'concat_first_emb']
